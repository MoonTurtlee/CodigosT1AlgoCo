...
/*
 * Resumen: Función principal que permite al usuario seleccionar un tipo de archivo y utiliza la función `std::sort` para ordenar varias listas de diferente tamaño.
 *
 * Parámetros:
 *  - Ninguno.
 *
